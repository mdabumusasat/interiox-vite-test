...
import MainLogo from "../../assets/images/logo-v4-black.png";
...
const Header = ({ handleOpen, handleRemove, searchToggle, handleToggle, scroll }) => {
    ...
    return (
        <>
          <header className={`main-header header-style-four home-style1 ${scroll ? "fixed-header" : ""} ${searchToggle ? "moblie-search-active" : ""}`}>
            <div className="header-lower">
              ...
              <div className="main-box">
                ...
                <div className="outer-box style-theme1">
                  <div className="ui-btn-outer">
                    <button className="ui-btn ui-btn search-btn" onClick={handleToggle}>
                      <span className="icon lnr lnr-icon-search"></span>
                    </button>
                    <Link to="/shop-cart" className="ui-btn cart-btn">
