...
import Thumb1 from '../assets/images/resource/client-2.jpg';
import Thumb2 from '../assets/images/resource/client-3.jpg';
...
function ShopDetails () {  
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-xl-6 product-info">
          <div className="product-details__top">
            <h3 className="product-details__title text-white">Backpack <span>$76.00</span> </h3>
          </div>
          ...
          <div className="product-details__content">
            ...
            <p className="product-details__content-text2"><strong className="text-white">REF.</strong> 4231/406 <br/> Available in store</p>
          </div>

          <div className="product-details__quantity">
            <h3 className="product-details__quantity-title text-white">Choose quantity</h3>
          ...
          <div className="product-details__social">
            <div className="title mt-10">
              <h3 className="text-white mb-2">Share with friends</h3>
            </div>
            <ul className="social-icon-two d-flex align-items-center gap-3 ms-4 product-share">
        ...
        <div className="tabs-box">
          ...
          <div className="tabs-content">
            <div className={activeIndex === 1 ? "tab active-tab" : "tab"} id="tab1">
              <div className="text">
                <h3 className="product-description__title text-white">Description</h3>
            ...
            <div className="customer-comment">
              ...
              <div className="comment-box dark-style">
                <h3 className="text-white">Add Your Comments</h3>
  ...
  <section className="related-product">
    <div className="container pt-0 pb-90">
      <h3 className="text-white">Related Products</h3>
      <div className="row">
