...
import ProgressBar from '../lib/ProgressBar2';
import TeamImage from "../assets/images/resource/team-details.jpg";
...
const TeamDetails = () => {
  return (
    <>
              ...
              <div className="col-xl-6 col-lg-6">
                <div className="team-details__top-right">
                  <div className="team-details__top-content">
                    <h3 className="team-details__top-name text-white">
                      Aleesha Brown
                    </h3>
            ...
            <div className="row">
              <div className="col-xl-6 col-lg-6">
                <div className="team-details__bottom-left">
                  <h4 className="team-details__bottom-left-title text-white">
                    Personal Experience
                  </h4>
                ...
                <div className="team-details__bottom-right">
                  <div className="team-details__progress">
                    <div className="team-details__progress-single">
                      ...
                      <ProgressBar targetPercentage={90} />
                    </div>
                    <div className="team-details__progress-single">
                      <h4 className="team-details__progress-title">Marketing</h4>
                      <ProgressBar targetPercentage={80} />
                    </div>
                    <div className="team-details__progress-single">
      ...
      <section className="team-contact-form dark-style">
        <div className="container pb-100">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <form
                ...
                <div className="mb-3 text-center d-flex justify-content-center gap-3 flex-wrap">
                  <input
                    name="form_botcheck"
                    className="form-control"
                    type="hidden"
