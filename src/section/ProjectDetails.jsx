...
import ProjectImage from "../assets/images/resource/service-details.jpg";
      ...
      <div className="row">
        <div className="col-xl-12">
          <div className="project-details__top">
            <div className="project-details__img"> <img src={ProjectImage} alt=""/> </div>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-xl-8 col-lg-8">
            <div className="project-details__content-left">
              <h3 className="text-white">Here to Know About This Project</h3>
              ...
              <h3 className="text-white">Reason For Choosing Us</h3>
              ...
              <h3 className="text-white">Logistic Solution for Your Business</h3>
              ...
              <div className="project-details__details-box">
                ...
                <ul className="list-unstyled project-details__details-list">
                  <li>
                    ...
                    <h4 className="project-details__name">22 June, 2026</h4>
                  </li>
                  <li>
                  ...
                  <li>
                    <div className="project-details__social"> <Link to="#"><i className="fa fa-x"></i></Link> <Link to="#"><i className="fab fa-facebook"></i></Link> <Link to="#"><i className="fab fa-pinterest-p"></i></Link> <Link to="#"><i className="fab fa-instagram"></i></Link> </div>
                  </li>
                </ul>
              </div>
            </div>
